...
public class ShardedJedisClientTemplate implements JedisClientTemplate{

	private static final Logger logger = LoggerFactory.getLogger(ShardedJedisClientTemplate.class);


	private static ShardedJedisClientTemplate instance;

	private JedisDataSource jedisDataSource;
	/**
	 * 単例实现 
	 */
	public static synchronized ShardedJedisClientTemplate getInstance(){
		if(null == instance){
			try{
				instance = new ShardedJedisClientTemplate();
			}catch(Exception e){
				e.printStackTrace();
			}
		}
	...
	private ShardedJedisClientTemplate(){
		jedisDataSource = JedisDataSource.getInstance();
	}


	public void disconnect() {
		ShardedJedis shardedJedis = (ShardedJedis)(ShardedJedis)jedisDataSource.getRedisClient();
