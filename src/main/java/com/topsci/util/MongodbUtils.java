...
public class MongodbUtils {
    ...
    public static Object  aggregate(Aggregation var1,String ss, Class var2) {
        return mongodbUtils.mongoTemplate.aggregate(var1,ss,var2).getMappedResults();
    }
    ...
    public static List<? extends Object> find(Class obj, Criteria criteria) {
        Query query = Query.query(criteria);
        List<? extends Object> resultList = mongodbUtils.mongoTemplate.find(query, obj);
        return resultList;
    }
     ...
     * @return
     */
    public static Object findOne(Class obj, String[] findKeys, Object[] findValues) {
     ...
     * @return
     */
    public static Object findOne(Class obj, String[] findKeys, Object[] findValues, String collectionName) {
     ...
     * @return
     */
    public static List<? extends Object> findAll(Class obj) {

        List<? extends Object> resultList = mongodbUtils.mongoTemplate.findAll(obj);
        return resultList;
    }
    ...
    public static int count(Class obj, String[] findKeys, Object[] findValues) {
        ...
        Query query = Query.query(criteria);
        long count = mongodbUtils.mongoTemplate.count(query, obj);
        return (int)count;
    }
    public static int count(Class obj, Criteria criteria) {
        Query query = Query.query(criteria);
        long count = mongodbUtils.mongoTemplate.count(query, obj);
        return (int)count;
    }
